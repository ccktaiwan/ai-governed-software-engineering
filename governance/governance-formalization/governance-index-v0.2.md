...
This document defines the authoritative index and cross-reference map for Governance Formalization v0.2.

Its purpose is to provide a single navigable entry point for governance specifications, ensuring that all governance rules, boundaries, and enforcement mechanisms can be discovered, referenced, and audited deterministically.
